...
accordionContent.forEach((item, index) => {
  ...
  header.addEventListener("click", () => {
    ...
    if (item.classList.contains("open")) {
      description.style.height = `${description.scrollHeight}px`; //scrollHeight özelliği, dolgu dahil ancak kenarlıklar, kaydırma çubuğu veya kenar boşluğu hariç bir öğenin yüksekliğini döndürür
      item.querySelector("i").classList.replace("fa-plus", "fa-minus");
    } else {
      description.style.height = "0px";
      item.querySelector("i").classList.replace("fa-minus", "fa-plus");
    }
    removeOpen(index); //işlevi çağırmak ve ayrıca tıklanan başlığın dizin numarasını geçmek
  })
})
